<?php
echo $crumb->getHtml('Edit Approval', null, '' ) ;
echo '<br /><br />' ;
?> 
<div class="approvals form">
<?php echo $this->Form->create('Approval');?>
	<fieldset>
 		<legend><?php __('Edit Approval'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Approval.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Approval.id'))); ?></li>
